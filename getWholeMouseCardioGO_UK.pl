...
#
# input file is
# 			cardioGO_UK_mouse_homolog_name.table   ------>getCardioGOMouseHomolog.pl  
#       gene_gtf_name.table  ---->getWholeName.pl

# the output file is 
#      cardioGO_UK.name.table
...
my $tf_table_name        = 'cardioGO_UK_mouse_homolog_name.table';
my $genename_table_name  = 'gene_gtf_name.table';

my $output_table_name    = 'cardioGO_UK.name.table';
